...
public class GetFranchiseUseCase implements GetFranchisePort {

    private final FranchiseRepositoryPort franchiseRepository;

    public GetFranchiseUseCase(FranchiseRepositoryPort franchiseRepository) {
        this.franchiseRepository = franchiseRepository;
    }

    @Override
    public Franchise execute(UUID id) {
        return franchiseRepository.findByIdWithBranchesAndProducts(id)
